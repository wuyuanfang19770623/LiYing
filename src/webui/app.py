...
def process_image(img_path, yolov8_path, yunet_path, rmbg_path, photo_type, photo_sheet_size, rgb_list, compress=False, change_background=False, rotate=False, resize=True, sheet_rows=3, sheet_cols=3):
...
def process_and_display(image, yolov8_path, yunet_path, rmbg_path, photo_type, photo_sheet_size, background_color, compress, change_background, rotate, resize, sheet_rows, sheet_cols):
    ...
    with gr.Blocks(theme=gr.themes.Soft()) as demo:
            ...
            with gr.Column(scale=1):
                ...
                with gr.Tabs() as tabs:
                    with gr.TabItem(t('key_param', initial_language)) as key_param_tab:
                        photo_type = gr.Dropdown(choices=photo_types, label=t('photo_type', initial_language))
                        photo_sheet_size = gr.Dropdown(choices=photo_types, label=t('photo_sheet_size', initial_language))
        ...
        def update_language(lang):
            ...
            return {
                ...
                photo_type: gr.update(label=t('photo_type', lang)),
                photo_sheet_size: gr.update(label=t('photo_sheet_size', lang)),
        ...
        lang_dropdown.change(
            ...
            outputs=[title, input_image, lang_dropdown, photo_type, photo_sheet_size, background_color, 
                     sheet_rows, sheet_cols, yolov8_path, yunet_path, rmbg_path, compress, 
                     change_background, rotate, resize, process_btn, output_image, 
        ...
        process_btn.click(
            process_and_display,
            inputs=[input_image, yolov8_path, yunet_path, rmbg_path, photo_type, photo_sheet_size, 
                    background_color, compress, change_background, rotate, resize, sheet_rows, sheet_cols],
