...
class PhotoRequirements:
    ...
    def get_requirements(self, photo_type):
        ...
        if requirements:
            return {
                'print_size': f"{requirements['PrintWidth']}cm x {requirements['PrintHeight']}cm" if requirements[
                                                                                                         'PrintWidth'] and
                                                                                                     requirements[
                                                                                                         'PrintHeight'] else 'N/A',
                ...
                'file_size': f"{requirements['FileSizeMin']}-{requirements['FileSizeMax']}KB" if requirements[
                                                                                                     'FileSizeMin'] and
                                                                                                 requirements[
                                                                                                     'FileSizeMax'] else 'N/A'
            }
        else:
            return None
